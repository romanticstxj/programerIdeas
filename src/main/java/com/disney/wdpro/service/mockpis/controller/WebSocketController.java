...
import com.disney.wdpro.service.mockpis.utils.WebSocketUtil;
 ...
 * @description
 * @date 2/18/21 5:56 PM
 */
//由于是websocket 所以原本是@RestController的http形式
//直接替换成@ServerEndpoint即可，作用是一样的 就是指定一个地址
//表示定义一个websocket的Server端, 在页面输入 ws://127.0.0.1:8090/programerIdeas/my-chat/michael
@Component
